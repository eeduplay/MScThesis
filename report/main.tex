...
\begin{document}
    ...
    \label{chp:app_YLR}
        \includepdf[pages=-, pagecommand={\thispagestyle{fancy}\markboth{}{}}]{assets/appendices/IPGLaser300-3000_calib.pdf}
    \chapter{P30 collimator calibration report}
    \label{chp:app_Collimator}
        \includepdf[pages=-, pagecommand={\thispagestyle{fancy}\markboth{}{}}]{assets/appendices/D30_Collimator_calib.pdf}
    \chapter{Cavitation apparatus drawings}
        ...
        \label{chp:app_CavitatorDrawings}
            \includepdf[pages=-, landscape=true]{assets/appendices/FULL_DRAWINGS_V4.pdf}
\end{document}