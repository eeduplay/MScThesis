    ...
    \section{Past facilities} \label{sec:background_exp}
        ...
        \subsection{Other LSP facilities}
            ...
            \begin{figure}[h]
                ...
                \caption[Difference in IB absorption coefficient between \ce{CO2}- and fiber-laser radiation]{Difference in IB absorption coefficient at a pressure of \qty{1}{bar} between \ce{CO2}-laser radiation and fiber-laser radiation}
                \label{fig:alphadiff}
            \end{figure}
